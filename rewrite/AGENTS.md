...
Project-level future analysis-core specifications have moved to
[docs/analysis-core](../docs/analysis-core/README.md). For that work, use its
checkpoint and prepared-field requirements; this file governs work on existing
rewrite implementations only. Its local ABI and milestone order are not the
new core's architecture.

Start each work cycle with [CURRENT.md](CURRENT.md). For spec convergence or
selection of a new outcome, read [baseline.md](../docs/analysis-core/baseline.md) before consulting
...
| When | Read | Authority |
| --- | --- | --- |
| Converging requirements, assessing existing assets, or entering a new implementation phase | [baseline.md](../docs/analysis-core/baseline.md) | Requirement status, asset roles, responsibility/evidence gaps, first-outcome readiness |
| First rewrite cycle, changed intent, or milestone boundary | [intent.md](../docs/analysis-core/intent.md) | Product goals, durable engineering constraints, scope |
| Selecting a consumer, algorithm, cache, or scientific workflow | [workflows.md](../docs/analysis-core/workflows.md) | Workload acceptance and priorities |
...
| Measuring or claiming performance/resource behavior | [performance.md](../docs/analysis-core/performance.md) | Evidence classes, budgets, comparisons, stopping rule |
