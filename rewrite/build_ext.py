...
def main() -> None:
    ...
    extensions = [
        ...
        Extension(
            "simesh_rewrite._restriction",
            [str(ROOT / "src/simesh_rewrite/_restriction.pyx")],
            include_dirs=[np.get_include()],
        ),
        Extension(
            "simesh_rewrite._limiter",
            [str(ROOT / "src/simesh_rewrite/_limiter.pyx")],
            include_dirs=[np.get_include()],
        ),
        Extension(
            "simesh_rewrite._prolongation",
            [str(ROOT / "src/simesh_rewrite/_prolongation.pyx")],
            include_dirs=[np.get_include()],
        ),
        Extension(
        ...
        Extension(
            "simesh_rewrite._target_boxes",
            [str(ROOT / "src/simesh_rewrite/_target_boxes.pyx")],
            include_dirs=[np.get_include()],
        ),
        Extension(
            "simesh_rewrite._relation_phases",
            [str(ROOT / "src/simesh_rewrite/_relation_phases.pyx")],
            include_dirs=[np.get_include()],
        ),
        Extension(
            "simesh_rewrite._same_level_boxes",
            [str(ROOT / "src/simesh_rewrite/_same_level_boxes.pyx")],
            include_dirs=[np.get_include()],
        ),
        Extension(
