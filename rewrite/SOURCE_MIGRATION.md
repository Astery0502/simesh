...
| --- | --- | --- | --- |
| Array/index/layout conventions | `amrvac/layouts.py`, canonical array APIs | Core 3D conventions, canonical payload/ID workspace accounting, and topology-free dense primary traversal complete; singleton-z pending | M2 and M6 |
