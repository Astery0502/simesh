...
| Physical, sibling, coarse/fine and periodic halos | `amrvac/boundary.py`, `mesh.pyx` | Physical/level-1 sibling boundaries plus refined restriction, limiter, prolongation, and bounded source-slot mapping complete; action/region plans and refined execution pending | M1 refined, then M2 and M3 |
