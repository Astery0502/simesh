...
| Pointwise, stencil, reduction and diagnostics | `derived_fields.py`, `mesh.pyx`, legacy diagnostic evidence | Native selected refined curl/reduction vertical slice complete with exact ROI and serial sum | M1 streamline slice; M4 for breadth |
