...
| Physical, sibling, coarse/fine and periodic halos | `amrvac/boundary.py`, `mesh.pyx` | Physical/level-1 sibling boundaries and refined ratio-two restriction primitive complete; refined limiter/prolongation, transfer plans, and execution pending | M1 refined, then M2 and M3 |
