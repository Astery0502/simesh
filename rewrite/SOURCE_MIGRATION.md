...
| Physical, sibling, coarse/fine and periodic halos | `amrvac/boundary.py`, `mesh.pyx` | Physical and level-1 sibling complete; level-1 relation/source planning extracted | Finish HAL-002 decomposition, then M1 refined, M2, M3 |
