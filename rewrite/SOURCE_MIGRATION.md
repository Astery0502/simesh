...
| Morton, forest, leaf traversal, connectivity | `utils/lib/amr/morton.pyx`, `forest.pyx` | Level-1/refined 3D reconstruction complete; conformance/contact/balance boundaries split | FST-002/TOP-002/BAL-001, then M2 quadtree and M3 periodic |
