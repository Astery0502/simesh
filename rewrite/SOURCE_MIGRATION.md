...
| Physical, sibling, coarse/fine and periodic halos | `amrvac/boundary.py`, `mesh.pyx` | Physical/level-1 sibling boundaries plus refined restriction, scalar limiter, and ratio-two prolongation complete; source-slot/transfer plans and refined execution pending | M1 refined, then M2 and M3 |
