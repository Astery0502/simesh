...
| --- | --- | --- | --- |
| Array/index/layout conventions | `amrvac/layouts.py`, canonical array APIs | Core 3D conventions, payload/ID workspace accounting, dense primary traversal, and direct-face support closure complete; singleton-z pending | M2 and M6 |
