...
| Physical, sibling, coarse/fine and periodic halos | `amrvac/boundary.py`, `mesh.pyx` | Physical/level-1 sibling boundaries plus refined restriction, limiter, prolongation, bounded source slots, directed targets, and child phases complete; source/workspace geometry and refined execution pending | M1 refined, then M2 and M3 |
