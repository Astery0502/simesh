...
| Morton, forest, leaf traversal, connectivity | `utils/lib/amr/morton.pyx`, `forest.pyx` | Level-1/refined 3D reconstruction and artifact conformance complete; contact/balance split | TOP-002/BAL-001, then M2 quadtree and M3 periodic |
