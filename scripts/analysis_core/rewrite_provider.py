"""Reuse validated rewrite components without hiding a package dependency.

Run development with PYTHONPATH=src:rewrite/src:scripts. The core itself never
imports this adapter. Source arrays and borrowed file descriptors must remain
unchanged/alive until preparation ends.
"""
...
from simesh.analysis import FieldSource, MeshIndex
from simesh.analysis.mesh import frozen_array
