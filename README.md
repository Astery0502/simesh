...
- **Input:** AMRVAC v5 snapshots, including compatible AGILE outputs, and
  equivalent array sources on balanced, three-dimensional Cartesian
...
- **Periodic input:** exact-phase halo preparation connects opposite real leaves,
  ...
  saved AMR slices reject periodic meshes.
- **Current limits:** spherical native analysis, periodic trajectories and magnetic
  connectivity, constrained-transport face-field analysis, and GPU execution are
  not supported. VTK export produces uniform volumes.
