...
def main(args):
    ...
    dirty = bool(subprocess.check_output(["git","-C",str(root),"status","--porcelain","--","analysis-core"],text=True).strip())
    report = {"revision":revision, "working_tree_dirty":dirty,"revision_scope":"analysis-core",
