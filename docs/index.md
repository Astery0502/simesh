...
[Developer documentation](dev/index.md) contains architecture, core and advanced
API references, compilation and docstring maintenance. Source docstrings are the
authoritative API descriptions; task guides provide usage context and examples.

Historical implementations are excluded from this documentation site.
Implementation provenance and licensing information are retained in
[ASSETS.md](../ASSETS.md).
