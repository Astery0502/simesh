...
that follow-up, and does not promote every mechanism proposed below.
...
[fixture contract](../../../../../previous/rewrite/WENO-REFERENCE.md#fixture-contract).
...
Relevant source: [mesh allocation and bulk kernels](../../../../../previous/src/simesh/utils/lib/amr/mesh.pyx),
[forest tables](../../../../../previous/src/simesh/utils/lib/amr/forest.pxd),
[field-axis rebuilding](../../../../../previous/src/simesh/amrvac/amrvac_dataset.py),
[derived materialization](../../../../../previous/src/simesh/amrvac/derived_fields.py),
[RHE preparation/application](../../../../../previous/rewrite/src/simesh_rewrite/refined_halo.py),
[CHS allocation/hits/misses](../../../../../previous/rewrite/src/simesh_rewrite/completed_halo_sampling.py)
and [SLE stage orchestration](../../../../../previous/rewrite/src/simesh_rewrite/field_lines.py).
...
Sources: [full comparison](../../../../../previous/rewrite/evidence/M1-WENO-REFERENCE-COMPARISON.md)
and [thin-query assessment](../../../../../previous/rewrite/evidence/M1-WENO-ASSESSMENT.md).
...
| --- | --- | --- |
| AMRVAC v5 index and file-order forest | `read_amrvac_v5_index` and `bind_amrvac_v5_forest` in [rewrite amrvac_dat.py](../../../../../previous/rewrite/src/simesh_rewrite/amrvac_dat.py) | Reuse metadata/flat forest and stable source leaf IDs; do not adopt an old executor just to obtain geometry |
| Selected native file reads | `make_amrvac_v5_block_reader` in [amrvac_dat_reader.py](../../../../../previous/rewrite/src/simesh_rewrite/amrvac_dat_reader.py) | Existing supported non-staggered v5 records; borrowed file descriptor; canonical field-first destination |
| Resident or memmap block input/output | `array_block_reader`, `array_block_writer`, `read_blocks_into`, `write_blocks_from` in [blockio.py](../../../../../previous/rewrite/src/simesh_rewrite/blockio.py) | Batch gather/scatter into explicitly owned backing; a block writer does not itself create an AMRVAC file |
| Original-file resident bootstrap | `get_metadata` and `read_blocks_sequential` in [canonical datio.py](../../../../../previous/src/simesh/amrvac/datio.py) | Can supply the recorded WENO ordinary fields; reads all leaves for selected fields, so count full input storage and startup |
| Complete supported AMRVAC output | `write_datfile_from_sfc` in [canonical datio.py](../../../../../previous/src/simesh/amrvac/datio.py) | Requires compatible SFC interiors and matching header/forest/tree; writes zero-ghost ordinary records, not arbitrary streamed analysis patches |
...
The [STO-003 contract](../../../../../previous/rewrite/contracts/STO-003.md) already expresses the
