...
class ExecutionTests(unittest.TestCase):
    def test_native_backend_conformance_or_explicit_unavailability(self):
        ...
        try:
            threaded=trace(pool,seeds,workers=4,backend='threadpool',schedule='dynamic',**opts)
            ...
            image=integrate_los(pool,plane,direction,tile_shape=(2,4),workers=4,backend='threadpool',schedule='dynamic')
