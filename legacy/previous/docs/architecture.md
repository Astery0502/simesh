...
core has a [fixed design](../../core-development/documentation-before-application-guide/development/next-generation-design.md); new application
work starts with its [application guide](../../core-development/documentation-before-application-guide/development/application-development.md).
Earlier architecture investigations remain in the [archive](../../core-development/documentation-before-application-guide/development/archive/README.md).
