...
The independent N4 core is fixed. Start with its [current state](../../core-development/documentation-before-application-guide/development/current.md),
[core boundaries](../../core-development/documentation-before-application-guide/development/next-generation-design.md) and
[application development guide](../../core-development/documentation-before-application-guide/development/application-development.md).
Earlier specifications, comparisons and heavy development procedures are in the
[archive](../../core-development/documentation-before-application-guide/development/archive/README.md), available when a specific question
