...
def integrate_thermal_los(thermodynamics, plane, direction, *, length_unit_cm,
    ...
    independent rays dispatched through one parallel layer. Auto uses OpenMP
    when compiled in, otherwise GIL-free Python workers. reference retains the
...
def _native_los(fields,plane,direction,near,far,subdivisions,max_samples,
    ...
    from simesh.utils.lib.analysis.thermal_rays import integrate_ready, openmp_build_info
