...
def prepare_resident(mesh_index, root_shape, forest_flags, interiors, definitions,
    ...
    stats = {"provider":"canonical","construct_and_copy_seconds":loaded-start,
             "forest_connectivity_seconds":connected-start,"mesh_allocation_seconds":allocated-connected,
             "interior_copy_seconds":loaded-allocated,
             ...
             "consumer_geometry_bytes":mesh.nbytes}
