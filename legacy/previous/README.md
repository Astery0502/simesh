...
[`analysis-core/`](../../README.md). Its experimental native-field,
magnetic tracing, LOS and bounded-output workflows are available in a separate
environment, with [bundled AMRVAC compatibility](../../MIGRATION.md).
See its [physical capabilities and output guide](../core-development/documentation-before-application-guide/capabilities-and-outputs.md)
for current calculations, result formats and complete examples.
...
The experimental `simesh.analysis` layer prepares native field groups for a whole
snapshot or a selected region and reuses them across successive analyses. It
provides bounded original-file access, parallel magnetic tracing/twist, global derivatives,
...
[Analysis-core documentation](../core-development/documentation-before-application-guide/development/README.md) records its selected
