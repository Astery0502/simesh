...
[its current checkpoint](../../core-development/documentation-before-application-guide/development/current.md), which supersedes the
...
- No rewrite implementation is active. Project-level spec work has moved to
  [docs/analysis-core](../../core-development/documentation-before-application-guide/development/README.md). Its current shared
...
- Baseline updated from the corrected side handoff: independent F tracing/Q/twist,
  ...
  [result-contract draft](../../core-development/documentation-before-application-guide/development/archive/core-development-2026-09-08/pipeline-results.md) records known scale,
...
- Intent clarification: documented and independently reviewed, 2026-09-07,
  ...
  [analysis catalog](../../core-development/documentation-before-application-guide/development/archive/core-development-2026-09-08/workflows.md) defines requested results, minimum
...
- Workflow-to-technique mapping: initial open inventory documented, 2026-09-07.
  [WORKFLOW_TECHNIQUES](../../core-development/documentation-before-application-guide/development/archive/core-development-2026-09-08/technique-candidates.md) relates twelve workflow families
...
- Lifetime/execution exploration: draft documented and independently reviewed,
  2026-09-07. The
  [shared design](../../core-development/documentation-before-application-guide/development/archive/core-development-2026-09-08/lifetime-sketches.md) describes ownership, invalidation
...
- For new spec work, follow the project checkpoint and
  [prepared-field requirements](../../core-development/documentation-before-application-guide/development/archive/core-development-2026-09-08/prepared-fields.md).
