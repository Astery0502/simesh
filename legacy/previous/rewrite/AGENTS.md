...
[docs/analysis-core](../../core-development/documentation-before-application-guide/development/README.md). This file governs explicitly
...
selection of a new outcome, read [baseline.md](../../core-development/documentation-before-application-guide/development/archive/core-development-2026-09-08/baseline.md) before consulting
...
| When | Read | Authority |
| --- | --- | --- |
| Converging requirements, assessing existing assets, or entering a new implementation phase | [baseline.md](../../core-development/documentation-before-application-guide/development/archive/core-development-2026-09-08/baseline.md) | Requirement status, asset roles, responsibility/evidence gaps, first-outcome readiness |
| First rewrite cycle, changed intent, or milestone boundary | [intent.md](../../core-development/documentation-before-application-guide/development/archive/core-development-2026-09-08/intent.md) | Product goals, durable engineering constraints, scope |
| Selecting a consumer, algorithm, cache, or scientific workflow | [workflows.md](../../core-development/documentation-before-application-guide/development/archive/core-development-2026-09-08/workflows.md) | Workload acceptance and priorities |
...
| Measuring or claiming performance/resource behavior | [performance.md](../../core-development/documentation-before-application-guide/development/archive/core-development-2026-09-08/performance.md) | Evidence classes, budgets, comparisons, stopping rule |
